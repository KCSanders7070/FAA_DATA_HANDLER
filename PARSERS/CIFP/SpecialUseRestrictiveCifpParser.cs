...
{
    /// <summary>
    /// Parses UR records into SpecialUseRestrictiveCifpDataModel.
    /// </summary>
    /// <remarks>
    /// Slices the 132-character record with ReadOnlySpan&lt;char&gt; so no intermediate strings are
    /// allocated for columns the model does not keep. Column boundaries come from ARINC 424 layout 4.1.18.1
    /// Restrictive Airspace (Special Use Airspace-UR) and were verified against every UR record in
    /// FAACIFP18.
    /// </remarks>
    public static class SpecialUseRestrictiveCifpParser
    {
        /// <summary>
        ...
        {
            var model = new SpecialUseRestrictiveCifpDataModel
            {
                ...
                RestrictiveAirspaceName = CifpFieldConverter.Field5126(line.Slice(93, 30)),
            ...
            cifpDataCollections.SpecialUseRestrictive.Add(model);
        }
    }
}