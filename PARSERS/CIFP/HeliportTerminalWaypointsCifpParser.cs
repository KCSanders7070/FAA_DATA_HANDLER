...
{
    /// <summary>
    /// Parses HC records into HeliportTerminalWaypointsCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Waypoint (Heli Terminal Waypoints-HC) and were verified against every HC record in FAACIFP18.
    /// </remarks>
    public static class HeliportTerminalWaypointsCifpParser
    {
        /// <summary>
        /// Parses one HC record and appends it to the collection.
        /// </summary>
        ...
        {
            var model = new HeliportTerminalWaypointsCifpDataModel
            {
                ...
                AirportHeliportIdentifier = CifpSpan.Text(line.Slice(6, 4)),
                AirportHeliportIcaoLocationCode = CifpFieldConverter.Field514(line.Slice(10, 2)),
            ...
            cifpDataCollections.HeliportTerminalWaypoints.Add(model);
        }
    }
}