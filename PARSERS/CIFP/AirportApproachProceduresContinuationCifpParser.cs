...
{
    /// <summary>
    /// Parses PF continuation records into AirportApproachProceduresContinuationCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Approach Level of Service Continuation Records (Approaches Continuation-PF) and were verified
    /// against every PF record in FAACIFP18.
    /// </remarks>
    public static class AirportApproachProceduresContinuationCifpParser
    {
        /// <summary>
        /// Parses one PF record and appends it to the collection.
        /// </summary>
        ...
        {
            var model = new AirportApproachProceduresContinuationCifpDataModel
            {
            ...
            cifpDataCollections.AirportApproachProceduresContinuation.Add(model);
        }
    }
}