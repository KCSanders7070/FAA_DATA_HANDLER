...
{
    /// <summary>
    /// Parses HF records into HeliportApproachProceduresCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Approach (Heli Approaches-HF) and were verified against every HF record in FAACIFP18.
    /// </remarks>
    public static class HeliportApproachProceduresCifpParser
    {
        /// <summary>
        ...
        {
            var model = new HeliportApproachProceduresCifpDataModel
            {
            ...
            cifpDataCollections.HeliportApproachProcedures.Add(model);
        }
    }
}