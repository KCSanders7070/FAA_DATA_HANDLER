...
{
    /// <summary>
    /// Parses PD records into StandardInstrumentDeparturesCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Airport SID (SIDs-PD) and were verified against every PD record in FAACIFP18.
    /// </remarks>
    public static class StandardInstrumentDeparturesCifpParser
    {
        /// <summary>
        /// Parses one PD record and appends it to the collection.
        /// </summary>
        ...
        {
            var model = new StandardInstrumentDeparturesCifpDataModel
            {
            ...
            cifpDataCollections.StandardInstrumentDepartures.Add(model);
        }
    }
}