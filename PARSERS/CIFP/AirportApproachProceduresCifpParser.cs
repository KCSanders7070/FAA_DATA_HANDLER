...
{
    /// <summary>
    /// Parses PF records into AirportApproachProceduresCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Approach (Approaches-PF) and were verified against every PF record in FAACIFP18.
    /// </remarks>
    public static class AirportApproachProceduresCifpParser
    {
        /// <summary>
        ...
        {
            var model = new AirportApproachProceduresCifpDataModel
            {
            ...
            cifpDataCollections.AirportApproachProcedures.Add(model);
        }
    }
}