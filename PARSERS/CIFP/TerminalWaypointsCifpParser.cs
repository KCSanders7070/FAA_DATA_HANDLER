...
{
    /// <summary>
    /// Parses PC records into TerminalWaypointsCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Waypoint (Terminal Waypoints-PC) and were verified against every PC record in FAACIFP18.
    /// </remarks>
    public static class TerminalWaypointsCifpParser
    {
        /// <summary>
        /// Parses one PC record and appends it to the collection.
        /// </summary>
        ...
        {
            var model = new TerminalWaypointsCifpDataModel
            {
            ...
            cifpDataCollections.TerminalWaypoints.Add(model);
        }
    }
}