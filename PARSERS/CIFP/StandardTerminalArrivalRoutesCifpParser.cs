...
{
    /// <summary>
    /// Parses PE records into StandardTerminalArrivalRoutesCifpDataModel.
    /// </summary>
    /// <remarks>
    ...
    /// Airport STAR (STARs-PE) and were verified against every PE record in FAACIFP18.
    /// </remarks>
    public static class StandardTerminalArrivalRoutesCifpParser
    {
        /// <summary>
        /// Parses one PE record and appends it to the collection.
        /// </summary>
        ...
        {
            var model = new StandardTerminalArrivalRoutesCifpDataModel
            {
            ...
            cifpDataCollections.StandardTerminalArrivalRoutes.Add(model);
        }
    }
}