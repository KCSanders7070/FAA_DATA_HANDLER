...
{
    /// <summary>
    /// FAACIFP18 File - StandardInstrumentDepartures (PD) record.
    /// </summary>
    /// <remarks>
    /// ARINC 424 layout 4.1.9.1 Airport SID (SIDs-PD). Identified by Section Code 'P' and Subsection Code
    /// 'D'. Continuation Record Number is at zero-based index 38; '0' or '1' marks a primary record and
    /// anything else a continuation.
    /// </remarks>
    public class StandardInstrumentDeparturesCifpDataModel
    {
        /// <summary>
