...
{
    /// <summary>
    /// FAACIFP18 File - HeliportTerminalWaypoints (HC) record.
    /// </summary>
    /// <remarks>
    /// ARINC 424 layout 4.1.4.1 Waypoint (Heli Terminal Waypoints-HC). Identified by Section Code 'H' and
    /// Subsection Code 'C'. Continuation Record Number is at zero-based index 21; '0' or '1' marks a
    /// primary record and anything else a continuation.
    /// </remarks>
    public class HeliportTerminalWaypointsCifpDataModel
    {
        /// <summary>
        ...
        /// </remarks>
        public string? AirportHeliportIdentifier { get; set; }

        /// <summary>
        /// Airport/Heliport ICAO Location Code
        /// _Ref: 5.14
        /// _Idx: 10:11
        /// _MaxLength: 2
        /// _DataType: String
        ...
        /// </remarks>
        public string AirportHeliportIcaoLocationCode { get; set; }
