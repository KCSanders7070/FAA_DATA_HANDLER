...
{
    /// <summary>
    /// FAACIFP18 File - AirportApproachProceduresContinuation (PF) continuation record.
    /// </summary>
    /// <remarks>
    /// ARINC 424 layout 4.1.9.5 Approach Level of Service Continuation Records (Approaches Continuation-
    /// PF). Identified by Section Code 'P' and Subsection Code 'F'. Continuation Record Number is at zero-
    /// based index 38; '0' or '1' marks a primary record and anything else a continuation.
    /// </remarks>
    public class AirportApproachProceduresContinuationCifpDataModel
    {
        /// <summary>
