...
{
    /// <summary>
    /// FAACIFP18 File - HeliportStandardInstrumentDepartures (HD) record.
    /// </summary>
    /// <remarks>
    /// ARINC 424 layout 4.1.9.1 Airport SID (SIDs-PD). Identified by Section Code 'H' and Subsection Code
    /// 'D'. Continuation Record Number is at zero-based index 38; '0' or '1' marks a primary record and
    /// anything else a continuation.
    /// </remarks>
    public class HeliportStandardInstrumentDeparturesCifpDataModel
    {
        /// <summary>
        ...
        /// <summary>
        /// SID/STAR/Approach Identifier - BasicIndicator
        /// _Ref: 5.9
        /// _Idx: 13:17
        /// _MaxLength: 5
        /// _DataType: String
        ...
        /// </summary>
        /// <remarks>
        /// Column 1 of the composite field 5.9 (SID/STAR Route Identifier). Six-column name of the SID or STAR,
        /// made up of a basic indicator followed by a single-digit validity (revision) number.
        /// <para>Layout note: SID/STAR IDs, see Section 5.9. IAP IDs, see Section 5.10.</para>
        /// </remarks>
        public string SidStarApproachIdentifierBasicIndicator { get; set; }

        /// <summary>
        /// SID/STAR/Approach Identifier - ValidityIndicator
        /// _Ref: 5.9
        /// _Idx: 13
        /// _MaxLength: 1
        /// _DataType: String
        ...
        /// <para>Layout note: SID/STAR IDs, see Section 5.9. IAP IDs, see Section 5.10.</para>
        /// </remarks>
        public string SidStarApproachIdentifierValidityIndicator { get; set; }
