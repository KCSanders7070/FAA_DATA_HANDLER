...
{
    /// <summary>
    /// FAACIFP18 File - HeliportApproachProcedures (HF) record.
    /// </summary>
    /// <remarks>
    /// ARINC 424 layout 4.1.9.1 Approach (Heli Approaches-HF). Identified by Section Code 'H' and
    /// Subsection Code 'F'. Continuation Record Number is at zero-based index 38; '0' or '1' marks a
    /// primary record and anything else a continuation.
    /// </remarks>
    public class HeliportApproachProceduresCifpDataModel
    {
        /// <summary>
